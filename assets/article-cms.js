(() => {
  ...
  const subcategoryLabels = { events_study:'勉強会', events_party:'パーティ・交流', events_policy:'党運営・政策関連・その他', events_member:'メンバー紹介', events_other:'その他' };
  ...
  async function load(){
    try{
      ...
      const image=a.image1||a.image2||''; document.title=`${a.title||'記事'}｜中くらいの政府`;
      mount.innerHTML=`
